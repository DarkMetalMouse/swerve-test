...
public class Constants {
    ...
    public static final class Drivetrain {
        public static class SwerveModuleConstants {
            ...
            public final int absEncoderPort;
            ...
            public SwerveModuleConstants(Translation2d position, 
                ...
                this.steeringZeroValue = steeringZeroValue;
            }
        }
        public static final SwerveModuleConstants TLModule = new SwerveModuleConstants(new Translation2d(-0.215, 0.215), 3, 4,1,0);
        public static final SwerveModuleConstants TRModule = new SwerveModuleConstants(new Translation2d(0.215, 0.215), 1, 2,0,587);
        public static final SwerveModuleConstants BLModule = new SwerveModuleConstants(new Translation2d(-0.215, -0.215), 5, 6,2,0);
        public static final SwerveModuleConstants BRModule = new SwerveModuleConstants(new Translation2d(0.215, -0.215), 7, 8,3,0);
    }
